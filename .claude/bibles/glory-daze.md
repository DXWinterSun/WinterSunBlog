...
- **Joanie 的体面收梢**：埋她和 Rob 的渐行渐远（可接 canon「不欢而散」），到分叉结局给她一个值得的
  去处，别悬空、别当反派处理掉。
- **🎀 腕带信物（Winter 定,甜点级,待回收）**：你有「低头做事就用运动腕带扎发」的习惯。
  **埋**：Ch2 起你这个小动作 + Rob 从你搬进来就偷偷在看（「你没注意到，楼上窗口有个人看了个遍」）。
  **回收**（放你俩更近一点的章节）：Rob 开始习惯性在手腕戴一根腕带,嘴上说「擦汗方便」,其实是等你
  要扎头发时,一脸满不在乎地把它扔给你——**心里其实是想帮你扎的**。到更后面可落到「他真的伸手替你
  扎」。这条是 Winter 亲点的甜点,务必回收。
...
（下一步 Ch6：日常暗涌——你揣着没说的心事继续当 C 和 D、继续写歌,「唯有音乐里才敢靠近」的甜与酸;
Jack×Dina/Mickey×Chelsea 日常。攒够 Ch4-6 三章一起发。）
