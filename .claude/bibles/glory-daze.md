...
4. **录像带**（`eit-ch4-draft.md`，待认可,攒批部署）——海边半正式演出(camcorder 录像)。**C/D 带刺版诞生**
   (台上 D／C is for Coward，回收 Ch1 藏力气)。社交:几个女孩问 Rob 单身吗→你「就我所知，是」;**Joanie
   只轻埋一线**(非唯一,眼睛亮亮多看一眼);**你此刻没心动**。心动=几天后看录像带,从台下/别人镜头里看见你俩
   的默契才后知后觉(收在「更贪恋台下这一种」)。Jack×Dina 热恋沙发背景。穿搭:你短裙长靴+腕带扎发、Rob
   粉缎衬衫。⚠️未预支保媒/Miss Delaney。
